...
// в топе дека держим минимум на отрезке: при сдвиге правого указателя элемент с бэка выталкивает все большие и встаёт, перед сдвигом левого проверяем ушёл ли текущий минимум и попаем если шо
